                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:310px;">
                                ...
                                <a class="btn btn-danger" href="/profile/orders/delete/<?php echo htmlspecialchars( $value1["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onclick="return confirm('Deseja realmente excluir este pedido?')" role="button">Excluir</a>
